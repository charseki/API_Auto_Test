...
```text
框架的各个模块功能请参考ReadMe文件夹中的：此框架流程图.xmind
```
说明：
```text
实际生产中处理比较麻烦的接口数据依赖问题，可以自己单独写提取参数的方法，再调用后进行测试。
要做到测试框架的真正落地，还需要结合生产中的业务需求出发。
```
Thank you：
```text
觉得此小项目对您有帮助的，请给我个Star！!!
```
接口测试平台：
```text
